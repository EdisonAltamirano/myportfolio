      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <FadeIn delay="delay-150">
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 font-display text-sm font-semibold tracking-wider uppercase text-primary hover:text-primary border border-black/10 hover:border-primary/30 px-6 py-3 rounded-md transition-all duration-300 group"
            >
              Learn More About Me
