    ...
    <section className="py-20 bg-muted/20 relative">
      <div className="container px-4 mx-auto">
        ...
        <FadeIn className="text-center mt-12">
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 font-display text-sm font-semibold tracking-wider uppercase text-muted-foreground hover:text-sky-400 border border-border hover:border-sky-500/40 px-6 py-3 rounded-sm transition-all duration-300 group"
          >
            View All Projects
