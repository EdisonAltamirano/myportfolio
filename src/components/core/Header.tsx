...
export function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-background/82 backdrop-blur-xl supports-[backdrop-filter]:bg-background/68">
      <nav className="container mx-auto flex h-16 items-center justify-between px-4 lg:px-8" aria-label="Primary navigation">
        <Link href="/" className="group flex items-center gap-3 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background">
          <span className="flex h-8 w-8 items-center justify-center rounded-lg border border-white/10 bg-white/[0.04] text-primary transition-colors duration-200 group-hover:border-white/20 group-hover:bg-white/[0.07]">
        ...
        <div className="flex lg:hidden">
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="w-80 border-l border-white/10 bg-background/95 p-0 backdrop-blur-xl">
              ...
              <div className="space-y-1 p-4">
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        active ? 'bg-white text-background' : 'text-muted-foreground hover:bg-white/[0.06] hover:text-foreground'
                      )}
                    >
                ...
                <Link
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setOpen(false)}
                  className="mt-4 block rounded-xl border border-white/12 px-4 py-3 text-center text-sm font-medium text-foreground transition-colors duration-150 hover:border-white/24 hover:bg-white/[0.06]"
                >
                  Download Resume
                </Link>
              </div>
